        ...
        <View style={styles.cardFlexBoxRow}>
          <Card mode="contained" style={styles.card}>
            <Card.Content style={styles.cardContentTall}>
              ...
              <Text variant="titleSmall">
                {response && response.hourly.temperature_2m[currentHour]} °C
              </Text>
              <Text variant="titleSmall">
                {response && response.hourly.precipitation_probability[currentHour]} %
              </Text>
            </Card.Content>
          </Card>
          ...
          <Card mode="contained" style={styles.card}>
            <Card.Content style={styles.cardContentTall}>
              ...
              <Divider style={{ height: 1, width: "160%" }} />
              <Text variant="titleSmall">
                {response && response.hourly.temperature_2m[currentHour + 1]} °C
              </Text>
              <Text variant="titleSmall">
                {response && response.hourly.precipitation_probability[currentHour + 1]} %
              </Text>
            </Card.Content>
          </Card>
          ...
          <Card mode="contained" style={styles.card}>
            <Card.Content style={styles.cardContentTall}>
              ...
              <Text variant="titleSmall">
                {
                  ...
                  response &&
                    Math.round(
                      ((response.daily.temperature_2m_min[2] +
                        response.daily.temperature_2m_max[2]) /
                        2) *
                        10
                    ) / 10
                }{" "}
              ...
              <Text variant="titleSmall">
                {response && response.daily.precipitation_probability_mean[2]} %
              </Text>
            </Card.Content>
          </Card>
        </View>
